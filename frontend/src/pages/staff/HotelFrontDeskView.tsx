// hotel-management/frontend/src/pages/staff/HotelFrontDeskView.tsx
...
const HotelFrontDeskView: React.FC = () => {
        ...
        <div style={{ padding: '24px', fontFamily: 'system-ui, sans-serif', background: '#0b192c', minHeight: '100vh', color: '#f8fafc' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: '1px solid #1e3a5f', paddingBottom: '16px', flexWrap: 'wrap', gap: '10px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    <button
                        onClick={() => navigate('/restaurant-frontdesk')}
                        style={{ padding: '8px 16px', background: '#0284c7', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 600 }}
                    >
                        🍽️ Switch to Restaurant Front Desk →
                    </button>
                    <button
                        onClick={() => navigate('/room')}
                        style={{ padding: '8px 16px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 600 }}
                    >
                        🛎️ Open In-Room Dining
                    </button>
                </div>
            </div>

            {/* In-House Dining Guidance Notice */}
            <div style={{ background: '#1e293b', border: '1px solid #3b82f6', borderRadius: '12px', padding: '14px 18px', marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div>
                        ...
                        <span style={{ color: '#cbd5e1', fontSize: '13px', marginLeft: '6px' }}>
                            Hotel Front Desk manages guest rooms, check-in, and in-room meal deliveries. If in-house guests wish to physically dine-in, they can be directed to the Restaurant Floor.
                        </span>
                    </div>
                </div>
                <button
                    onClick={() => navigate('/restaurant-frontdesk')}
                    style={{ padding: '6px 12px', background: '#0369a1', color: '#fff', border: 'none', borderRadius: '6px', fontSize: '12px', fontWeight: 600, cursor: 'pointer' }}
                >
                ...
                {[
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: roomFilter === tab.id ? '#1d4ed8' : '#1e293b',
                            color: '#f8fafc',
                            fontWeight: 600,
                            fontSize: '13px',
                            cursor: 'pointer',
...
export default HotelFrontDeskView;
