export {};
// hotel-frontend/server.ts
// Hotel Management & In-Room Services SPA Server on Port 3001
...
if (!buildResult.success) {
    console.error('Failed to bundle hotel-frontend:', buildResult.logs);
}
...
console.log(`🏨 Hotel Management Frontend running on http://0.0.0.0:${port} (proxied to ${backendUrl})`);
